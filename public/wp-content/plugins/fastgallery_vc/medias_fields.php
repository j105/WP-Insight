<?php
$attchments_fastgallery_vc_options = array(    
    'custom_url' => array(
        'label'       => __('Image Link', 'fgvc'),
        'input'       => 'text',
        'application' => 'image',
...
Class FastGallery_VC_Custom_Medias_Fields {
...
$fg_vc_cmf = new FastGallery_VC_Custom_Medias_Fields($attchments_fastgallery_vc_options);