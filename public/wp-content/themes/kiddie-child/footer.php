            ...
            <?php if ( get_theme_mod( 'show_footer_social','show' ) == 'show' ) {?>
              <ul id="ztl-social">
                <?php if ( get_theme_mod( 'facebook_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'facebook_social_link','#' ) ); ?>" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'google_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'google_social_link','#' ) ); ?>" title="Google +"><i class="fa fa-google-plus"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'twitter_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'twitter_social_link','#' ) ); ?>" title="Twitter"><i class="fa fa-twitter"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'youtube_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'youtube_social_link','#' ) );?>" title="Youtube"><i class="fa fa-youtube"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'pinterest_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'pinterest_social_link','#' ) );?>" title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'instagram_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'instagram_social_link','#' ) );?>" title="Instagram"><i class="fa fa-instagram"></i></a></li>
                <?php } ?>
                <?php if ( get_theme_mod( 'wechat_social_link','#' ) ) { ?>
                  <li> <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'wechat_social_link','#' ) );?>" title="Wechat: <?php echo get_theme_mod( 'wechat_social_link','#' );?>" alt="Wechat: <?php echo get_theme_mod( 'wechat_social_link','#' );?>"><i class="fa fa-weixin"></i></a></li>
                <?php } ?>
              </ul>
            <?php } ?>
          </div>
